...
# Wolfram APi
WOLFRAM_APP_ID = "WAGWUP-JYHQ6EEK8H"
# Weather API
OPENWEATHER_API_KEY = "87ce813a15ad3d1c0f079934ed85ab26"

# Email id and Password
EMAIL_ADDRESS = "dishanksingh36@gmail.com"
EMAIL_PASSWORD = "uawrvtubskpplooo"

# music directory
MUSIC_DIR = "C:\\Users\\Public\\Music\\Sample Music"

# dictionary of contacts for WhatsApp/Email
# names and phone numbers/email addresses
CONTACTS = {
    "dhruv": {"phone": "+919335963323", "email": "dhruvkumar60229@gmail.com"},
    "divyansh": {"phone": "+916387814302", "email": "divyanshgupta173@gmail.com"},
}
...
# list PhotoImage objects for GIF animation
listening_frames = []
speaking_frames = []
animation_index = 0
...
def create_ui():
    ...
    # Load GIF frames for animationsl
    if not load_gif_frames("GOOD GIF.gif", listening_frames): # Replace with your GIF path
        print("Listening animation GIF not found or corrupted. Animations will not play.")
    if not load_gif_frames("Voice assistant motion effect .gif", speaking_frames): # Replace with your GIF path
